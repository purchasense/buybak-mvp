...
class BuyBakAlsaceWineToolSpec(BaseToolSpec):
    """BuyBak French Wines Tool spec."""

    spec_functions = [
        "get_query_engine_tools_for_alsace_wine",
    ]

    def __init__(self):
        print('BBK: Initializing Query Engine Tools for Alsace Wine')
        ...
        print('------ init alsace_wine query_engine_index done --------')


    def get_query_engine_tools_for_alsace_wine(self) -> []:
        """Query Engine Tools for Alsace Wines"""
        print("Inside get_query_engine_tools_for_alsace_wine")
