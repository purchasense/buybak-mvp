...
export class MobileChatMessage {
    ...
    constructor( id: String, user: String, msg: String)
    {
        this.id = id;
        this.user = user;
        this.msg = msg;
